...
public class CryptoTool {
	...
	public static BigInteger createNumber(String number) {
	...
	public static BigInteger getSecureRandom(int bound) {
	...
	public static ArrayList<BigInteger> extendedGCD(BigInteger aBig, BigInteger bBig) {
	...
	public static BigInteger chineseRemainder(ArrayList<BigInteger> aList, ArrayList<BigInteger> mList) {
    ...
    // = n-1 for some r >= 1
    public static boolean miillerTest(BigInteger n) {
