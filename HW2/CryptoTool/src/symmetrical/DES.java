...
public class DES {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("DES Key (Hex Form):"+bytesToHex(secKey.getEncoded()));
    ...
    public static SecretKey getSecretEncryptionKey() throws Exception{
        ...
        generator.init(56); // The AES key size in number of bits
        SecretKey secKey = generator.generateKey();
        return secKey;
    }
    
    /**
     * Encrypts plainText in DES using the secret key
     * @param plainText
     * @param secKey
     * @return
     * @throws Exception 
